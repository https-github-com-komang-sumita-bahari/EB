...
KP =()=>{
  this.props.navigation.navigate('KebijakanPrivasi')
}
DataP =()=>{
  this.props.navigation.navigate('DataPribadi')
}
...
English= () =>{
 ...
 setTimeout(()=>{
  db.transaction(tx => {   
    db.transaction(tx => {
      tx.executeSql('insert into tbl_settings (s_setting, s_bahasa) values (?,?)', [0,2]);
    });
  });
    ...
    return (
      <Container>
         ...
         <Left style={{marginTop:2}}>
          ...
          <Title style={{marginTop:15,marginLeft:-120,fontFamily:'SourceSansProBold', fontSize:20}}>     Pengaturan</Title>
         ...
         <BottomSheet
          ...
          onBackdropPress={this._toggleModal}>
            ...
            <View >
               ...
               <Text style={{marginLeft:20,fontSize:11,marginTop:20}}>Nama</Text>
              
             <CardItem style={styles.carditem}>
      
              <Item>
                <Icon active name='person' style={styles.input}/>
                <Input placeholder='Nama' style={styles.input} value={this.state.U_nama} onChangeText={UserNama => this.setState({U_nama:UserNama})}/>
              </Item>
             </CardItem>
             <Text style={{marginLeft:20,fontSize:11,marginTop:20}}>Alamat Email</Text>
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='mail' style={styles.input}/>
                <Input placeholder='Alamat E-Mail' value={this.state.U_email} style={styles.input} keyboardType="email-address" onChangeText={UserEmail => this.setState({U_email:UserEmail})}/>
              </Item>
             </CardItem>
             <Text style={{marginLeft:20,fontSize:11,marginTop:20}}>Telepon</Text>
             <CardItem style={styles.carditem}>
              <Item>
        ...
        <BottomSheet
          ...
          onBackdropPress={this._toggleModal2}>
            ...
            <View style={styles.view}>
              <Title style={{marginTop:15, fontFamily:'SourceSansProBold'}}>Ubah Sandi</Title>
              <Right>
            ...
            <View >
             ...
             <CardItem style={styles.carditem}>
              <Item>
                ...
                <Input placeholder='Password Lama' style={styles.input} secureTextEntry = {this.state.hidePassword} maxLength={15} onChangeText={PasswordLama => this.setState({PasswordLama})}/>
             ...
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='lock' style={styles.input}/>
                <Input placeholder='Password Baru' style={styles.input}  secureTextEntry = {this.state.hidePassword2} maxLength={15} onChangeText={PasswordBaru => this.setState({PasswordBaru})}/>
             ...
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='lock' style={styles.input}/>
                <Input placeholder=' Konfirmasi Password Baru' style={styles.input} secureTextEntry = {this.state.hidePassword3} maxLength={15} onChangeText={KonfirmasiPasswordBaru => this.setState({KonfirmasiPasswordBaru})}/>
        ...
        <View style={{width:'100%', backgroundColor:'#fff'}}>
            <CardItem style={{height:45,backgroundColor:'transparent'}}>
              <Text style={{fontSize:15, fontFamily:'Roboto'}}>Data Pribadi</Text>
              <Right>
              <TouchableOpacity onPress={this._toggleModal}>
                <Text style={{fontSize:15, fontFamily:'Roboto', color:'#3F81B5'}}>Ubah</Text>
                </TouchableOpacity >
              </Right>
            </CardItem>
        ...
        <View style={{width:'100%', backgroundColor:'#fff', marginTop:10}}>
          <TouchableOpacity onPress={this._toggleModal2}>
              <CardItem style={{height:45,backgroundColor:'transparent'}}>
                  ...
                  <Text style={{fontSize: 15, fontFamily:'Roboto'}}>     Ubah Sandi                              </Text>
                  <Right>
        ...
        <View style={{width:'100%', backgroundColor:'#fff', marginTop:2}}>
              ...
              <CardItem style={{height:45,backgroundColor:'transparent'}}>
                  ...
                  <Text style={{fontSize: 15, fontFamily:'Roboto'}}>     Bahasa </Text>
                  <View style={{marginLeft:10}}>
                    <CardItem style={{backgroundColor:'transparent'}}>
                     <Button style={{height:25, fontSize:10, marginLeft:10, borderRadius:7, backgroundColor:this.state.bgColor}}><Text>Indonesia</Text></Button>
                     <Text> </Text>
                     <Button onPress={this.English} style={{height:25, fontSize:10, borderRadius:7, backgroundColor:this.state.bgColor2}}><Text style={{color:'#000'}}>Inggris</Text></Button>
                     </CardItem>
                  </View>
              </CardItem>
        ...
        <View style={{width:'100%', backgroundColor:'#fff', marginTop:2}}>
          <TouchableOpacity onPress={this.SnK}>
            <CardItem style={{height:45,backgroundColor:'transparent'}}>
                ...
                <Text style={{fontSize:15, fontFamily:'Roboto'}}>     Syarat dan ketentuan                    </Text>
                <Right>
                    <Icon active name="ios-arrow-forward" />
                </Right>
            </CardItem>
        ...
        <View style={{width:'100%', backgroundColor:'#fff', marginTop:2}}>
          <TouchableOpacity onPress={this.KP}>
            <CardItem style={{height:45,backgroundColor:'transparent'}}>
                ...
                <Text style={{fontSize: 15, fontFamily:'Roboto'}}>     Kebijakan privasi                      </Text>
                <Right>
                    <Icon active name="ios-arrow-forward" />
                </Right>
            </CardItem>
