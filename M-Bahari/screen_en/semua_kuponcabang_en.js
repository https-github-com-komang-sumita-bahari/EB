      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <Left>
          ...
          <Title style={{marginTop:15,marginLeft:-140}}>Coupon</Title>
          </View>
        </Header>

         <Content style={{backgroundColor:'#fff'}}>
         <View style={{width: '100%' }}>
                <Text style={{fontSize: 20, fontWeight: 'bold', marginTop:10}}>    Coupon Reward</Text>
                <Text style={{fontSize: 12, marginLeft:20}}>Redeem your points and get coupon. </Text>
            </View>
            { 
