...
export default class Runcian extends Component {
  ...
  constructor(props) {
    ...
    this.state = { loading: true,
                   ...
                   namakupon_en: this.props.navigation.state.params.namakupon_en,
                   ...
                   cara:[{desk: 'Perform the ticket booking process.'},
                          {desk: 'Click the "USE THE PROMO OR COUPON CODE" button.'},
                          {desk: 'A list of coupons that you currently have will appear.'},
                          {desk: 'Then choose one of the coupons you want to use.'}]
                 };
      ...
      <Header style={{backgroundColor:'#3F81B5', height:20,}}></Header> 
         ...
         <View style={{width:'100%', alignItems:'center'}}>
            ...
            <CardItem style={{backgroundColor:'transparent'}}>
                <Text style={{fontWeight: 'bold',}}>{this.state.namakupon_en}</Text>
            </CardItem>
            ...
            <CardItem style={{marginTop:-10, backgroundColor:'transparent'}}>
                <Text style={{fontSize:12}}>{this.state.deskripsi_en}</Text>
            </CardItem>
            </View>
            </View>
            <Collapse isCollapsed={this.state.collapsed} onToggle={(isCollapsed)=>this.setState({collapsed:isCollapsed})}>>
                ...
                <Card style={{height:40, marginTop:20}}>
                    <CardItem style={{height:40}}>
                        <Text style={{fontSize: 14, fontFamily:'SourceSansProBold'}}>Terms and Conditions</Text>
        ...
        <Left style={{marginLeft:10}}>
            <CardItem style={{height:15, marginLeft:-10}}>
              ...
              <Text style={{fontSize: 16, fontWeight: 'bold', color:'#ff6600'}}>   {this.state.point} Point</Text>
            </CardItem>
            <Text style={{fontSize: 12}}>  My Points : {this.state.frmtPoint}</Text>
        </Left>
        <Right>
             <TouchableOpacity style={[styles.ButtonStyle, { backgroundColor: this.state.ButtonStateHolder ? '#607D8B' : '#3F81B5' }]} 
          activeOpacity = { .5 } 
