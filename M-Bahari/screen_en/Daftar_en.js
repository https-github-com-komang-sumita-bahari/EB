        ...
        <Header style={{backgroundColor:'#3F81B5', marginTop:0,}}>
         ...
         <KeyboardAvoidingView>
          <View style={{alignItems: 'center',}}>
            <Text style={{fontSize:18, marginBottom:10, color:'#fff'}}>Create Account</Text>
            <Card style={styles.card}>
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='person' style={styles.input}/>
                <Input placeholder='Name' style={styles.input} onChangeText={UserNama => this.setState({UserNama})}/>
              </Item>
             </CardItem>
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='mail' style={styles.input}/>
                <Input placeholder='Email Address' style={styles.input} keyboardType="email-address" onChangeText={UserEmail => this.setState({UserEmail})}/>
              </Item>
             </CardItem>
             <CardItem style={styles.carditem}>
              <Item>
