...
handleBackButtonClick() {
  ...
  getPromo=(id_promo,kode_promo,deskripsi,deskripsi_en,nama,nama_en,berlaku,image_en,image)=>
    {
         ...
         <Content style={{backgroundColor:'#fff'}}>
          ...
          (
            <View key = { key } style = { styles.promo }>
                 <ListItem>
                 <Body>
                 <TouchableOpacity onPress={this.getPromo.bind(this, promo.id_promo,promo.kode_promo,promo.deskripsi,promo.nama,promo.deskripsi_en,promo.nama_en,promo.berlaku,promo.image,promo.image_en)}>
                 ...
                 <Card style={{width:'100%',height:125, borderRadius:8}}>
                  ...
                  <Text numberOfLines={1} style={{fontSize:18, width:300, fontFamily:'SourceSansProBold'}}>{promo.nama_en}</Text>
                  <Text numberOfLines={2} style={{fontSize:12, width:300, fontFamily:'SourceSansProRegular'}}>{promo.deskripsi_en}</Text>
                  </TouchableOpacity>
                  </Body>
                  </ListItem> 
            </View>
