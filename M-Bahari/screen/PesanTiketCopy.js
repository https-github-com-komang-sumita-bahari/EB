...
fetch('http://expressbahari.com/php_mobile/Cek_Promo.php', {
  ...
  cekKeberangkatan=()=>{
    ...
    if(this.state.JenisTiket=='PP'){
      ...
      ToastAndroid.show('Jadwal Pulang Tidak Tersedia', ToastAndroid.LONG); 
    }
   }
    ...
    if(this.state.JenisTiket=='Sekali Jalan'){
      ...
      this.setState ({tampilDetailHarga:false  });
      ToastAndroid.show('Jadwal Pergi Tidak Tersedia', ToastAndroid.LONG); 
    }
   }
  }
...
_toggleModal = () =>{
  ...
  _modalDewasa=()=>{
    this.setState({ ModalDewasa: !this.state.ModalDewasa});
    this.setState({ footerhide: !this.state.footerhide })
    if(this.state.ModalDewasa==true){
      this.setState({ValueDewasa:0 });
    }
  }
  simpanModalDewasa=()=>{
    ...
    this.setState({ ModalDewasa: !this.state.ModalDewasa});
    this.setState({ footerhide: !this.state.footerhide })
    this.setState({viewvisibleKelas:true });
    }
    else{
     this.setState({ ModalDewasa: !this.state.ModalDewasa});
    this.setState({ footerhide: !this.state.footerhide })
    ...
    .then((responseJson) => {
      ...
      this.setState({
       ...
       if(this.state.lengthJadwal.length ==1){
        ...
        this.setState({jadwalPergi:true, ETA:this.state.lengthJadwal[0].tiba, ETD:this.state.lengthJadwal[0].berangkat});
        
       }
       if(this.state.lengthJadwal.length>1){
        //this.setState({viewvisiblePenumpang:true});
        this.setState({jadwalPergi:true,BottomPopUp:true,tampilUbahJadwal:true,tampilUbahJadwal:true,tampilJadwal2:false, tampilJadwal:true});
  ...
  Navigate_To_Second_Activity=(rute,kode_asal,kode_tujuan,asal,tujuan,kode_rute, asuransi,pass_pelabuhan,infant,kode_rute2,pass_pelabuhan2,infant2,potongan_pp,nama_pelabuhan,nama_pelabuhan2,rute2,asal2,kode_asal2,tujuan2,kode_tujuan2)=>
    {
     ...
     this.setState({viewvisiblePergi:true})
    }
 ...
 saveData = () =>{
    ...
    _renderHeader = section => {
      return (
        <Card style={{height:40,}}>
          ...
          <Text style={{fontSize: 15,}}>Dewasa {section.idx+1}</Text>
    ...
    let kewarganegaraan =[{
      ...
      return (
          ...
          <View style={{ width:'95%',marginTop:-15,marginBottom:5, margin:10,backgroundColor:'#fff'}}>
    ...
    return (
      ...
      <BottomSheet
        ...
        <BottomSheet
          ...
          onBackdropPress={this._toggleBottomNavigationView2}>
           <View >
                   <Text style={{color:'#ffffff'}}>        Silahkan Pilih Waktu Keberangkatan</Text>
              </View>  
              <View style={{height:'100%', width:'100%',backgroundColor:'#fff'}}>
      ...
      <Dialog
       ...
       <BottomSheet
              ...
              <View style={{flexDirection:'row', marginTop:15, alignItems:'center'}}>
                <View style={{width:'40%', alignItems:'center'}}>
                  ...
                  <DatePicker
                    ...
                    onDateChange={(date) => {this.setState({date: date,colorbg:'#F4F0E5'}),this.toggleSwitch(),this.cekJadwal()}}
                  />
                  </View>:
                  ...
                  {this.state.viewvisiblePP?<Text style={{fontSize: 15, color:'#000', marginTop:9, fontWeight: 'bold', position:'absolute'}}>{moment(this.state.date2).format('DD MMM YYYY')}</Text>:<Icon name='add' style={{fontSize:30,marginTop:4,position:'absolute'}} />}
                   ...
                   onDateChange={(date) => {this.setState({date2: date, JenisTiket:'PP',tampilJadwal2:false,tampilJadwal:false}),this.toggleSwitchPP(),this.cekPP()}}
                  />
                  </View>:
                  <View style={{height:40, backgroundColor:'#fcfbf8', width:'97%', borderRadius:10,marginTop:6, alignItems:'center'}}>
                  <Icon name='add' style={{fontSize:30,marginTop:4,position:'absolute', color:'#F4F0E5'}} />
               ...
               <View style={{height:122, backgroundColor:this.state.colorbg, width:'93%', borderRadius:10,marginTop:5, marginLeft:10, alignItems:'center'}}>
                  <View style={{flexDirection:'row', margin:8, alignItems:'center'}}>
                    ...
                    {this.state.viewvisiblePenumpang?<View style={{width:'50%'}}>
                     <Button block style={{backgroundColor:'#3F81B5', height:30,borderRadius:5 }} onPress={this._modalDewasa}><Text>{this.state.ValueDewasa}</Text></Button>
                    </View>
                    :<View style={{width:'50%'}}>
                     <View block style={{backgroundColor:'#F4F0E5', height:30,borderRadius:5 }} ><Text style={{color:'#fcfbf8'}}></Text></View>
                    </View>
                    }
                  </View>
          ...
          activeOpacity = { .5 } 
          onPress={this.simpanModalDewasa} >
            <Text style={{color:'#ffffff', alignItems:'center'}}>Simpan</Text>
        </TouchableOpacity>
        </Footer>    
                    </View>
                  ...
                  <View style={{flexDirection:'row', margin:8, marginTop:-2, alignItems:'center'}}>
                    ...
                    <View style={{width:'5%'}}/>
                    {this.state.viewvisiblePenumpang?<View style={{width:'50%'}}>
                     <Button block style={{backgroundColor:'#3F81B5', height:30,borderRadius:5 }}><Text><Icon name='add' style={{fontSize:18,marginTop:3,position:'absolute', color:'#fff'}}></Icon></Text></Button>
                    </View>:<View style={{width:'50%'}}>
                     <View block style={{backgroundColor:'#F4F0E5', height:30,borderRadius:5 }}><Text></Text></View>
                    </View>
                  }
                  </View>
...
{this.state.tampilJadwal2?
            ...
            {this.state.lengthJadwal.map((lengthJadwal)=>{
                ...
                <View key={lengthJadwal.id}>
                    ...
                    <Text style={{fontSize: 18, marginTop:20 , fontFamily:'SourceSansProBold'}}>Ringkasan Pesanan</Text>
                    <View style={{backgroundColor:'#fff', borderRadius:10, marginTop:10}}>
                    <CardItem style={{height:20,backgroundColor:'transparent', marginTop:5}}>
                        <Text style={{fontSize: 16,fontWeight: 'bold',}}>{this.state.asal} <Icon name="arrow-round-forward" style={{fontSize:12}} /> {this.state.tujuan}</Text>                        
                    </CardItem>

                    <CardItem style={{height:20,backgroundColor:'transparent'}}>
                         <Text style={{fontSize: 12}}>{this.state.KelasTiket} - </Text>
                         <Text style={{fontSize: 12}}>{this.state.JenisTiket} </Text>
                    </CardItem> 
                    <CardItem style={{height:20, backgroundColor:'transparent'}}>
                         <Text style={{fontSize: 10}}>{moment(this.state.date).format('dddd')} {moment(this.state.date).format('DD MMM YYYY')}, {lengthJadwal.berangkat} - {lengthJadwal.tiba}</Text>
                         <Right>
                        {this.state.tampilUbahJadwal?<TouchableOpacity onPress={this.UbahJadwal}><Text style={{fontSize: 11,color:'#3F81B5',fontWeight: 'bold'}}>Ubah Jam Keberangkatan</Text>
                        </TouchableOpacity>
                        :null
                        }
                        </Right>
            ...
            <ListItem>  
                ...
                return (
                   ...
                   <CardItem style={{marginLeft:20, backgroundColor:'#F4F0E5'}}>
                    ...
                    <CardItem style={{height:30,marginLeft:20, backgroundColor:'#F4F0E5'}}>
                         <Text style={{fontSize: 10}}>{moment(this.state.date).format('dddd')} {moment(this.state.date).format('DD MMM YYYY')}, {this.state.ETD} <Icon name="arrow-round-forward" style={{fontSize:12}} /> {this.state.ETA}</Text>
                         <Right>
                    ...
                    <CardItem style={{height:30,marginLeft:20, backgroundColor:'#F4F0E5'}}>
                         <Text style={{fontSize: 10}}>{moment(this.state.date2).format('dddd')}{moment(this.state.date2).format('DD MMM YYYY')}, {this.state.ETD} <Icon name="arrow-round-forward" style={{fontSize:12}} /> {this.state.ETA}</Text>
                         <Right>
                        {this.state.tampilUbahJadwal?<TouchableOpacity onPress={this.UbahJadwal}><Text style={{fontSize: 13,color:'#3F81B5',fontWeight: 'bold'}}>Ubah Jadwal</Text>
                        </TouchableOpacity>
                        :null
