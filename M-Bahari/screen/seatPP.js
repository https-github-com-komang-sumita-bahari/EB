      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <Left>
          ...
          <Title style={{marginTop:15,}}>Pilih Seat Pulang</Title>
          </View>
        </Header>
