...
export default class Runcian extends Component {
  ...
  loadings2=()=>{
    ...
    setTimeout(()=>{
      this.props.navigation.navigate('Transfer2_en',{totalbayar:this.state.totalbayar,limit:this.state.limit,no_pesanan:this.state.no_pesanan})
      this.setState({loading2: !this.state.loading2});
  ...
  getValue=(id,tanggal_pergi,kode_rute1,jenis_tiket)=>
    {
     ...
     this.props.navigation.navigate('detail_Pesanan_en',{no_pesanan:this.state.no_pesanan,jenis_tiket:this.state.jenis_tiket,})
      ...
      <Spinner visible={this.state.loading1}/>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <Left>
          ...
          <Title style={{marginTop:15,}}>   Your Payment is Being Processed</Title>
