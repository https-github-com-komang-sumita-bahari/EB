...
export default class Runcian extends Component {
  ...
  constructor(props) {
    ...
    deskripsi_en: this.props.navigation.state.params.deskripsi_en,
    ...
    collapsed:true,
    collapsed2:true,
    cara:[{desk: 'Copy the Promo Code available by pressing the "COPY" button.'},
    {desk: 'Enter the "Ticket Order" menu or by using the "TICKET MESSAGE" button.'},
    {desk: 'Perform the ticket booking process.'},
    {desk: 'Click the "USE THE PROMO OR COUPON CODE" button.'},
    {desk: 'Enter promo code.'},
    {desk: 'Then click the "USE" button.'}]
  };
  }
      ...
      <Container>
         ...
         <Button transparent onPress={() =>
            ...
            <CardItem style={{height:1, marginTop:-10,backgroundColor:'transparent'}}>
                <Text style={{fontSize:14, fontFamily:'SourceSansProRegular'}}>Valid Until : {moment(this.state.berlaku).format('DD MMM YYYY')}</Text>
            </CardItem>
            ...
            <CardItem style={{marginTop:-10}}>
                <Text style={{fontSize:13, fontFamily:'SourceSansProRegular'}}>{this.state.deskripsi_en}</Text>
            </CardItem>
            
            <View style={{alignItems:'center', backgroundColor:'#fff'}}>
            <CardItem style={{height:40}}>
              <Image source={require('../images/icon_promo.png')} style={{width:20, height:20}}/>
              <Text style={{fontSize:18, fontFamily:'SourceSansProBold',}}> PROMO CODE  </Text>
            </CardItem>
            </View>
                ...
                <CardItem>
                  <View style={{height:40, width:'90%', backgroundColor:'#F4F0E5', alignSelf:'center', borderRadius:8 ,}}>
                    <CardItem style={{height:20, backgroundColor:'transparent',marginTop:8}}>
                        ...
                        <Right>
                          <Text style={{fontSize:12, color:'#3F81B5', fontStyle:'italic', fontWeight: 'bold'}} onPress={this.writeToClipboard}>COPY</Text>
                        </Right>
                    </CardItem>
                  </View>
                </CardItem>
            ...
            <CardItem style={{backgroundColor:'transparent'}}>
                <Text style={{fontSize:13, fontFamily:'SourceSansProRegular'}}>See more details in the Terms and Conditions.</Text>
            </CardItem>
            </View>
            </View>
            <Collapse isCollapsed={this.state.collapsed} onToggle={(isCollapsed)=>this.setState({collapsed:isCollapsed})}>>
                ...
                <Card style={{height:40, marginTop:20}}>
                    <CardItem style={{height:40}}>
                        <Text style={{fontSize: 15, fontFamily:'SourceSansProBold'}}>Terms and Conditions</Text>
            ...
            <Collapse isCollapsed={this.state.collapsed2} onToggle={(isCollapsed)=>this.setState({collapsed2:isCollapsed})}>>
                ...
                <Card style={{height:40}}>
                    <CardItem style={{height:40}}>
                        <Text style={{fontSize: 15, fontFamily:'SourceSansProBold',}}>How To Use                    </Text>
                        <Right>
        ...
        <Footer style={{backgroundColor:'#3F81B5'}}>
          <Button transparent onPress={this.pesanTiket}>
              <Text style={{color:'#ffffff', fontFamily:'SourceSansProBold', fontSize:18}}>Reservation</Text>
          </Button>
        </Footer>
      </Container>
    );
