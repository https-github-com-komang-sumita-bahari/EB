  ...
  _modalDewasa=()=>{
    ...
    if(this.state.ModalDewasa==true){
        ...
        if (this.state.tomboldewasa==true){
            ...
            this.setState({tomboldewasa:false, ValueDewasa:0,show_icon:true});
      ...
      <Dialog
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <View style={styles.view}>
          <Title style={{marginTop:15}}>{this.state.ETD}Cari Tiket{this.state.ETA}</Title>
          <Right>
...
{this.state.tampilJadwal2?
            ...
            {this.state.lengthJadwal.map((lengthJadwal)=>{
                ...
                <View key={lengthJadwal.id} style={{borderRadius:10, backgroundColor:'#fff', marginTop:5, width:'92%'}}>
                    ...
                    <CardItem style={{height:30, backgroundColor:'transparent'}}>
                         <Text style={{fontSize: 13}}>{moment(this.state.date).format('dddd')} {moment(this.state.date).format('DD MMM YYYY')}, {lengthJadwal.berangkat} - {lengthJadwal.tiba}</Text>
                         <Right>
...
<TouchableOpacity onPress={this._toggleModalInputPromo}>
  <Text style={{fontSize: 13, color:'#3F81B5'}}>O-Gunakan Kupon/Promo</Text>
</TouchableOpacity>
</CardItem>:
<CardItem style={{height:10,}}>
...
{this.state.hideTombolGunakan ?<CardItem style={{height:10,}}>
<TouchableOpacity onPress={this._toggleModalInputPromo}>
  <Text style={{fontSize: 13, color:'#3F81B5'}}>P-Gunakan Kupon/Promo</Text>
</TouchableOpacity>
</CardItem>:
<CardItem style={{height:10,}}>
<TouchableOpacity onPress={this.batalKupon  }>
