      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <Left>
          ...
          <Title style={{marginTop:13,fontFamily:'SourceSansProBold', fontSize:20,marginLeft:-110}}>PICK YOUR SEAT</Title>
          </View>
        </Header>
        ...
        <Header style={{backgroundColor:'#F4F0E5', height:40,}}>
          ...
          <View>
            <CardItem style={{backgroundColor:'transparent'}}>
              ...
              <Text style={{fontSize:12, fontFamily:'SourceSansProRegular'}}>  Available</Text>
              <View style={{height:13, width:13, backgroundColor:'#FF2D00', borderRadius:2, marginLeft:25}}/>
              <Text style={{fontSize:12, fontFamily:'SourceSansProRegular'}}>  Unavailable</Text>
              <View style={{height:13, width:13, backgroundColor:'#31648C', borderRadius:2, marginLeft:25}}/>
              <Text style={{fontSize:12, fontFamily:'SourceSansProRegular'}}>  Selected</Text>
            </CardItem>
          </View>
        ...
        <Footer style={{backgroundColor:'#3F81B5',}}>
            <Button transparent style={{width:'100%'}}  onPress={ () => this.UpdateSeat()}>
              <Body>
                <Text style={{color:'#ffffff', fontFamily:'SourceSansProBold'}}>Save</Text>
              </Body>
            </Button>
        </Footer>}
      </Container>
