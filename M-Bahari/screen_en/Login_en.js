       ...
       if(responseJson === 'Data Matched')
        {
            ...
            this.props.navigation.navigate('home_en',{UserEmail:this.state.UserEmail})
...
<View style={{alignItems: 'center',}}>
            ...
            <Card style={styles.card}>
             ...
             <CardItem style={{backgroundColor:'transparent'}}>
              ...
              <CardItem style={{backgroundColor:'transparent'}}>
                ...
                <TouchableOpacity  onPress={() => navigate ('lupaPassword')}><Text style={{fontFamily:'Font1'}}>Forgot ?</Text></TouchableOpacity>
                </Right>
              </CardItem>
         ...
         <View style={styles.signupTextCont}>
          ...
          <TouchableOpacity  onPress={() => navigate ('Daftar_en')}><Text style={styles.signupButton}> Sign Up</Text></TouchableOpacity>
        </View>
          </KeyboardAvoidingView>
          </ImageBackground>
          </View>
