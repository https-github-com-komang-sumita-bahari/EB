    ...
    return (
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         ...
         <Left style={{marginTop:2}}>
          ...
          <Title style={{marginTop:15,fontFamily:'SourceSansProBold', fontSize:20}}>Ship Departure Schedule</Title>
          
          </View>
        </Header>
       <WebView
        source={{uri: 'http://jadwal.expressbahari.com/jadwal_en.html'}}
