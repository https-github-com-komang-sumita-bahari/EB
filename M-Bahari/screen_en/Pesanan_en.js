...
loadings=()=>{
    ...
    setTimeout(()=>{
      ...
      this.props.navigation.navigate('detail_Pesanan_en',{no_pesanan:this.state.no_pesanan,detailPP:this.state.detailPP,jenis_tiket:this.state.jenis_tiket})
      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         <View style={styles.view}>
          ...
          <Title style={{marginTop:15,fontFamily:'SourceSansProBold', fontSize:21}}> MY BOOKING</Title>
         ...
         <Content style={{backgroundColor:'#F4F0E5'}}>
            ...
            <View style={{alignItems:'center',position:'relative',marginTop:-50}}>
              ...
              <View style={{backgroundColor:'#fff', margin:10, borderRadius:30, alignItems:'center'}}>
                  <Text style={{fontSize:16, fontFamily:'SourceSansProBold', color:'#000'}}>My Active E-Ticket</Text>
          ...
          <View style={{alignItems:'center'}}>
            ...
            <Text style={{fontSize:18, fontFamily:'SourceSansProBold', marginBottom:20, marginTop:10}}>There is no active e-ticket</Text>
          </View>}
          </View>
          </View>
          </View>
            ...
            <CardItem style={{backgroundColor:'#fff',marginTop:10}}>
                <Text style={{fontSize:18, fontFamily:'SourceSansProBold'}}>On Process</Text>
            </CardItem>
                    ...
                    <Card style={{borderRadius:10}}>
                     <TouchableOpacity active badge vertical onPress={this.pindah}>
                        ...
                        <Image source={require('../images/icon_proses.png')} style={{width:35, height:30}}/>
                            <Text style={{fontSize: 15, fontFamily:'SourceSansProBold'}}>   View Booking </Text>
