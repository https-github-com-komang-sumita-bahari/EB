...
clearAsyncStorage = async() => {
 ...
 TampilAlert = () => {
     ...
     Alert.alert(
    'Info',
    'Are you sure want log out from this account?',
    [
...
loadings=()=>{
  ...
  Ubah =()=>{
  this.props.navigation.navigate('settings_en')
}
  render() {
      ...
      <Container>
        ...
        <Header style={{backgroundColor:'#3F81B5',}}>
         <View style={styles.view}>
          ...
          <Title style={{marginTop:15,fontFamily:'SourceSansProBold', fontSize:20}}> My Account</Title>
          ...
          onBackdropPress={this._toggleBottomNavigationView}>
              ...
              <View style={styles.bottomNavigationView}>
                  ...
                  <View style={{ width:'100%'}}>
                    ...
                    <Text style={{color:'#000000'}}>Telephone</Text>
                    </TouchableOpacity>
                    </ListItem>
                  </View>
              </View>
          ...
          onBackdropPress={this._toggleBottomNavigationView2}>
              ...
              <View style={styles.bottomNavigationView}>
                  ...
                  <View style={{ width:'100%'}}>
                    ...
                    <Text style={{color:'#000000'}}>Delete Photo</Text>
                    </TouchableOpacity>
                    </ListItem>
                  </View>
                  <View style={{ width:'100%'}}>
          ...
          <ImageBackground source={require('../images/bg_akun.jpg')} imageStyle={{ borderBottomLeftRadius:20, borderBottomRightRadius:20,}} style={{height:150, width:'100%', alignItems:'center', }}>
            ...
            <View style={{width:'100%', alignItems:'center', position:'relative',marginTop:-30}}>
              ...
              onPress={this.point}>
                  ...
                  {
                    this.state.loadPoint?<View>
                      <Text style={{fontSize: 17,fontFamily:'SourceSansProBold'}}>   {this.state.frmtPoint} Points                 </Text>
                  </View>:
                  <View>
               ...
               <Card style={{width:'95%', borderRadius:10}}>
                  ...
                  <CardItem style={{height:45,backgroundColor:'transparent'}}>
                      ...
                      <Text style={{fontSize:15, fontFamily:'Roboto'}}>    Help                           </Text>
                      <Right>
                          <Icon active name="ios-arrow-forward" />
                      </Right>
                  </CardItem>
                  ...
                  <CardItem style={{height:45,backgroundColor:'transparent'}}>
                      ...
                      <Text style={{fontSize: 15, fontFamily:'Roboto'}}>    Settings                         </Text>
                      <Right>
                          <Icon active name="ios-arrow-forward" />
                      </Right>
                  </CardItem>
                  ...
                  <CardItem style={{height:45,backgroundColor:'transparent'}}>
                      ...
                      <Text style={{fontSize:15, fontFamily:'Roboto'}}>    Log Out                              </Text>
                      <Right>
                          <Icon  active name="ios-arrow-forward" />
                      </Right>
                  </CardItem>
