            ...
            <Card style={styles.card}>
             ...
             <CardItem style={styles.carditem}>
              <Item>
                ...
                <Input placeholder='Password Lama' style={styles.input} secureTextEntry={true} maxLength={15} onChangeText={PasswordLama => this.setState({PasswordLama})}/>
              </Item>
             </CardItem>
             <CardItem style={styles.carditem}>
              <Item>
                <Icon active name='lock' style={styles.input}/>
                <Input placeholder='Password Baru' style={styles.input} secureTextEntry={true} maxLength={15} onChangeText={PasswordBaru => this.setState({PasswordBaru})}/>
              </Item>
             </CardItem>
              <CardItem>
              </CardItem>
              ...
              <CardItem>
                ...
                <TouchableOpacity  onPress={() =>this.lupaPassword()}><Text>Lupa password ?</Text></TouchableOpacity>
                </Right>
              </CardItem>
           </Card>
          </View>
